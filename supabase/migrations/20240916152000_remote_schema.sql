...
CREATE POLICY "device_insert" ON "public"."devices" FOR INSERT WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "device_select" ON "public"."devices" FOR SELECT USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
